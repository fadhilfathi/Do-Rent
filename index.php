	...
	<div class="sidebar">
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<li><a href="#">Alat Camping<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="#">Mountaineering<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="#">Outbond<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="#">Komunikasi & Multimedia<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="#">Penerangan<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
			</ul>
		</nav>
	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="owl-item">
					<div class="background_image" style="background-image:url(gambar/time-health-stock-sleep-camping.jpg)"></div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="gambar/perlengkapan camping/tenda dome_20.000.jpg" alt=""></div>
							<div class="box_title trans_200"><a href="categories.html">Alat Camping</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="gambar/alat komunikasi/walkie talkie_10.000.jpg" alt=""></div>
							<div class="box_title trans_200"><a href="categories.html">Komunikasi & Multimedia</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="gambar/outbound/jaring-jaring_200.000.jpg" alt=""></div>
							<div class="box_title trans_200"><a href="categories.html">Outbond</a></div>
						</div>
					</div>
					...
					<div class="col">
						<div class="products_container grid">
							...
							<div class="product grid-item hot">
								<div class="product_inner">
									<div class="product_image">
										<img src="gambar/mountaineering/jaket tebal_7500.jpg" alt="">
							...
							<div class="product grid-item">
								<div class="product_inner">
									<div class="product_image"><img src="gambar/mountaineering/jaket tebal_7500.jpg" alt=""></div>
									<div class="product_content text-center">
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_contact">
								...
								<div class="footer_contact_list">
									<ul>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>C.</span><div>Company Ltd</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>A.</span><div>Makassar</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>T.</span><div>+62</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>E.</span><div>@gmail.com</div></li>
									</ul>
								</div>
							</div>
						</div>
